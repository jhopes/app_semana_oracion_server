...
INSERT INTO `cantico` VALUES (1,1,'No me olvidé de Ti ','Si las pruebas de esta vida debilitan ya tu fe,\n y en tu mente surgen dudas de que venga otra vez./n Mira hoy hacia el Calvario, a la cruz donde sufrí,\n Qué más prueba quieres que esta: Te amé hasta morir?\n\n Coro\nAunque pienses que demoro y sientas que me atraso,\nUn día prometí volver y pronto lo cumpliré.\nAunque pienses que demoro y sientas que me atraso,\nyo no me olvidé de ti, vendré otra vez.\n\n¿Te parece que podría olvidarme de cumplir,\nsi en la historia de este mundo rojas huellas ya dejé?\nSi una madre se olvidara de su hijo alguna vez,aun así jamás pensaría olvidarme yo de ti.',1);
...
-- Dump completed on 2017-04-26 18:56:37
